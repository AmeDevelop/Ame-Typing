...
public class MusicExtention : MonoBehaviour
{
	...
	static MusicExtention Current_;
	static List<MusicExtention> MusicList_ = new List<MusicExtention>();
	...
	public static void Play(string musicName, string sectionName = "") { MusicList_.Find((MusicExtention m) => m.name == musicName).PlayStart(sectionName); }
	/// <summary>
...
public class Timing : IComparable<Timing>, IEquatable<Timing>
{
	...
	public int CurrentMusicalTime { get { return GetMusicalTime(MusicExtention.CurrentSection); } }
	public int GetMusicalTime(MusicExtention.Section section)
	{
		return Bar * section.UnitPerBar + Beat * section.UnitPerBeat + Unit;
	}
	public void Fix(MusicExtention.Section section)
	{
	...
	public void Increment(MusicExtention.Section section)
	{
		Unit++;
		Fix(section);
	}
	public void Decrement(MusicExtention.Section section)
	{
		Unit--;
		Fix(section);
	}
	public void IncrementBeat(MusicExtention.Section section)
	{
		Beat++;
		Fix(section);
	}
	public void Add(Timing t, MusicExtention.Section section)
	{
		Bar += t.Bar;
		Beat += t.Beat;
		Unit += t.Unit;
	...
	public void Subtract(Timing t, MusicExtention.Section section)
	{
		Bar -= t.Bar;
		Beat -= t.Beat;
		Unit -= t.Unit;
